...
"[project]/storage/components/FileUploader.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
        ...
        "UserPage.useEffect": ()=>{
            ...
            const getInitialUser = {
                "UserPage.useEffect.getInitialUser": async ()=>{
                    const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$storage$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    if (user) {
                        setUserId(user.id);
            ...
            const { data: subscription } = __TURBOPACK__imported__module__$5b$project$5d2f$storage$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
...
//# sourceMappingURL=_9a843d96._.js.map