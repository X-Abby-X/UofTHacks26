...
/* build-hook-start *//*00001*/try { require('/Users/shrut/.vscode/extensions/wallabyjs.console-ninja-1.0.508/out/buildHook/index.js').default({tool: 'next.js', checkSum: '2067890f8b5da072dad662BwEWCB5VAgQEAgBWVAsFWVxXAwQE', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/shrut/.vscode/extensions/wallabyjs.console-ninja-1.0.508/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '2067890f8b5da072dad662BwEWCB5VAgQEAgBWVAsFWVxXAwQE', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"16.1.3"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
