...
//             {/* NEW: Synthetic Exam Generation Link */}
...
//                         pathname === '/assessment' 
//                         ? 'bg-[#8B5CF6]/20 border-[#8B5CF6]/60 shadow-[0_0_20px_rgba(139,92,246,0.15)]' 
//                         : 'bg-white/5 border-white/10 hover:border-[#8B5CF6]/40 hover:bg-[#8B5CF6]/5'
//                     }`}
//                 >
//                     <div className="flex items-center gap-4">
//                         <div className={`p-2.5 rounded-xl transition-colors ${
//                             pathname === '/assessment' ? 'bg-[#8B5CF6] text-white' : 'bg-white/5 text-white/40 group-hover:text-[#8B5CF6]'
//                         }`}>
//                             <Cpu className="w-4 h-4" />
//                         </div>
//                         <div>
//                             <span className="block text-[11px] font-black uppercase tracking-widest text-white">Synthetic Exam</span>
//                             <span className="block text-[9px] text-white/30 font-mono uppercase tracking-tighter">Neural_Gen_v1.0</span>
//                         </div>
//                     </div>
//                     <ChevronRight className={`w-4 h-4 transition-all ${
//                         pathname === '/assessment' ? 'text-[#8B5CF6] translate-x-1' : 'text-white/10 group-hover:text-[#8B5CF6] group-hover:translate-x-1'
//                     }`} />
//                 </motion.div>
//             </Link>
...
//   // N3XU$ LOGIC: Button is hidden until at least one milestone has a numerical score
//   const hasSubmission = milestones && milestones.some(m => m.score !== undefined && m.score !== null);
//   const hasData = milestones && milestones.length > 0;

//   // UofT GPA Scale Approximation Logic
//   const targetPercentage = Math.round(((targetGPA - 1) / 3) * 100);
...
//             {/* 4. CONDITIONAL FEATURE: Synthetic Exam (Unlocked via Submission) */}
//             <AnimatePresence>
//               {hasSubmission && (
//                 <motion.div
...
//                             pathname === '/genQuestions' 
//                             ? 'bg-[#8B5CF6]/20 border-[#8B5CF6]/60 shadow-[0_0_20px_rgba(139,92,246,0.15)]' 
//                             : 'bg-white/5 border-white/10 hover:border-[#8B5CF6]/40'
//                         }`}
//                     >
//                         <div className="flex items-center gap-4">
//                             <div className={`p-2.5 rounded-xl transition-colors ${
//                                 pathname === '/genQuestions' ? 'bg-[#8B5CF6] text-white' : 'bg-white/5 text-white/40 group-hover:text-[#8B5CF6]'
//                             }`}>
//                                 <Cpu className="w-4 h-4" />
//                             </div>
//                             <div>
...
//                         </div>
//                         <ChevronRight className={`w-4 h-4 transition-all ${
//                             pathname === '/genQuestions' ? 'text-[#8B5CF6] translate-x-1' : 'text-white/10 group-hover:text-[#8B5CF6] group-hover:translate-x-1'
//                         }`} />
//                     </motion.div>
//                   </Link>
//                 </motion.div>
...
//             {/* 5. Identity Resonance (Frequency) */}
//             <div className={`p-5 rounded-2xl border transition-colors duration-500 ${isOnTrack ? 'border-emerald-500/30 bg-emerald-500/5' : 'border-[#EC4899]/30 bg-[#EC4899]/5'}`}>
//               <div className="flex items-center justify-between mb-2">
//                 <span className={`text-xs uppercase tracking-wider font-bold flex items-center gap-2 ${isOnTrack ? 'text-emerald-400' : 'text-white/60'}`}>
//                   <Sparkles className="w-3 h-3" /> {isOnTrack ? 'Full Resonance' : 'Identity Resonance'}
...
//               <span className="text-[10px] uppercase tracking-[0.2em] text-white/30 font-black px-1">Growth Chronicle</span>
//               <div className="space-y-2">
//                 {milestones.map((m, idx) => (
//                   <div key={idx} className="flex justify-between items-center p-3 rounded-xl bg-white/[0.02] border border-white/5 transition-colors hover:bg-white/[0.05]">
//                     <span className="text-[11px] font-bold text-white/70">{m.name}</span>
//                     <span className={`text-xs font-black ${m.score !== undefined ? 'text-emerald-400' : 'text-white/10'}`}>
//                       {m.score !== undefined ? `${m.score}%` : `${m.weight}%`}
//                     </span>
    ...
    >
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-xl font-black uppercase tracking-tighter text-white font-mono">Persona</h2>
            <div className={`text-[10px] uppercase tracking-[0.2em] font-bold ${isOnTrack ? 'text-emerald-400' : 'text-[#EC4899]'}`}>
              {isOnTrack ? 'Resonance Active' : 'Alignment Required'}
            </div>
          </div>
        </div>
      </div>
        ...
        {!hasData ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            ...
            <div className={`p-5 rounded-2xl border transition-colors duration-500 ${isOnTrack ? 'border-emerald-500/30 bg-emerald-500/5' : 'border-[#EC4899]/30 bg-[#EC4899]/5'}`}>
              <div className="flex items-center justify-between mb-2">
                <span className={`text-xs uppercase tracking-wider font-bold flex items-center gap-2 ${isOnTrack ? 'text-emerald-400' : 'text-white/60'}`}>
                  <Sparkles className="w-3 h-3" /> Resonance Frequency
                </span>
                <span className={`text-[10px] font-black ${isOnTrack ? 'text-emerald-400' : 'text-[#EC4899]'}`}>{projectedGrade}%</span>
              </div>
              <div className="flex items-end gap-1 h-12">
